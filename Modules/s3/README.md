...
sample-flink-jar/README.md updated successfully
...
| <a name="input_is_flink_bucket"></a> [is\_flink\_bucket](#input\_is\_flink\_bucket) | Controls if S3 flink JAR object should be created | `bool` | `false` | no |
