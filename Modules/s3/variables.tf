...
variable "is_lambda_code_bucket" {
  description = "Controls if S3 lambda sample zip object should be created"
  type        = bool
  default     = false
}

variable "is_flink_bucket" {
  description = "Controls if S3 flink JAR object should be created"
  type        = bool
  default     = false
}

variable "is_debezium_connector_bucket" {
  description = "Controls if debezium msk connector JAR object should be created"
  type        = bool
  default     = false
}
