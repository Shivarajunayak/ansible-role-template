...
| [aws_secretsmanager_secret.redis_auth_token_secret](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/secretsmanager_secret) | data source |
| [aws_secretsmanager_secret_version.redis_auth_token_secret_version](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/secretsmanager_secret_version) | data source |
## Inputs
...
| <a name="input_auth_token_update_strategy"></a> [auth\_token\_update\_strategy](#input\_auth\_token\_update\_strategy) | Auth Token Update Strategy | `string` | `"SET"` | no |
...
| <a name="input_enable_redis_auth"></a> [enable\_redis\_auth](#input\_enable\_redis\_auth) | Enable redis auth | `bool` | `false` | no |
...
| <a name="input_redis_auth_token_secret_name"></a> [redis\_auth\_token\_secret\_name](#input\_redis\_auth\_token\_secret\_name) | Redis Auth Token Secret Name | `string` | `""` | no |
...
| <a name="input_transit_encryption_mode"></a> [transit\_encryption\_mode](#input\_transit\_encryption\_mode) | Transit Encryption Mode | `string` | `"preferred"` | no |
