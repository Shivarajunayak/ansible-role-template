...
variable "broker_vpc_id" {
  description = "Broker VPC ID"
  type        = string
  default     = ""
}
...
variable "broker_node_client_subnets" {
  description = "A list of subnets to connect to in the client VPC (documentation: https://docs.aws.amazon.com/msk/1.0/apireference/clusters.html#clusters-prop-brokernodegroupinfo-clientsubnets)"
  type        = list(string)
  default     = ["subnet-0fe951b96f66b6b5e", "subnet-018d83867993c1abf"]
}
...
variable "client_authentication" {
  description = "Configuration block for specifying client authentication"
  type        = any
  default     = {}
}
...
variable "configuration_name" {
  ...
  type        = string
  default     = "my-kafka-config"
}

variable "configuration_description" {
  description = "Description of the configuration"
  type        = string
  default     = "My Kafka cluster configuration"
}
...
variable "scaling_role_arn" {
  ...
  type        = string
  default     = "arn:aws:iam::637423293078:role/aws-service-role/kafka.application-autoscaling.amazonaws.com/AWSServiceRoleForApplicationAutoScaling_KafkaCluster"
}
