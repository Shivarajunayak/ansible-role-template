...
aws-iam/README.md updated successfully
aws-iam-invoked/README.md updated successfully
...
| <a name="input_iam_configs"></a> [iam\_configs](#input\_iam\_configs) | List of iam roles to be created | `any` | `[]` | no |
