...
variable "use_pod_secondary_cidr" {
  description = "Whether Pods will use secondary CIDR"
  type        = bool
  default     = false
}

variable "pod_secondary_cidr_azs" {
  description = "Secondary CIDR AZs in alphabetical order"
  type        = list(string)
  default     = []
}

variable "pod_secondary_cidr_subnets" {
  description = "Secondary CIDR Subnets in alphabetical order"
  type        = list(string)
  default     = []
}
...
variable "irsa_configs" {
  description = "List of irsa roles to be created"
  type        = any
  default     = []
}
...
variable "management_cluster_state" {
  type    = any
  default = {}
}
