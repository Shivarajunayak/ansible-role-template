...
variable "karpenter_nodepools" {
  description = "Karpenter Nodepool Configuration"
  type        = any
  default     = {}
}
...
variable "kubecost_helm_config" {
  ...
  description = "KubeCost add-on configurations"
  type        = any
  default     = {}
}
...
variable "enable_openebs" {
  description = "Opensebs addons"
  type        = any
  default     = {}
}

variable "enable_volume_cleanup" {
  description = "Volume clean up controller"
  type        = bool
  default     = false
}

variable "enable_nodelocaldnscache" {
...
variable "eks_addons_helm_releases" {
  type    = any
  default = {}
}

variable "enable_istio_peerauth" {
  type    = bool
  default = false
}
